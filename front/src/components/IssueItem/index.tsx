...
import { Link, Pre, IssueItemContainer, StausBadge, TextLine } from '../../presententionalComponents';
...
export function IssueItem({ number, title, closed, body, searchTerm, author, createdAt }: IssueItemProps) {
  return (
    <IssueItemContainer>
      <TextLine>
